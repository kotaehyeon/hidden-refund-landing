...
|--------|------|----------------------|
| `implant.html` | 임플란트 지원 | 지원유형 카드 1 + 네비 1 |
| `loan.html` | 정부 대출 | 지원유형 카드 2 + 네비 2 |
| `cancer.html` | 암보험 환급 | 지원유형 카드 3 + 네비 3 |
| `unemployment.html` | 실업급여 | 지원유형 카드 4 + 네비 4 |
| `elderly.html` | 어르신 대상 안내 | 대상별 버튼 1 (👴 어르신) |
| `employee.html` | 직장인 대상 안내 | 대상별 버튼 2 (👔 직장인) |
| `selfemployed.html` | 자영업자 대상 안내 | 대상별 버튼 3 (🏪 자영업자) |
| `nojob.html` | 무직자 대상 안내 | 대상별 버튼 4 (📋 무직자) |
...
### 3-5. CTA 버튼
- CSS: `.content-cta` (신규) — 파란 버튼, padding 16px, href="#"
- 텍스트: "지금 신청하기 →"
